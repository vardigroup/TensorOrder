...
#ifndef HTD_IO_CUSTOMGRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
#define HTD_IO_CUSTOMGRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
...
namespace htd_io
{
     ...
     */
    class CustomGrFormatGraphToTreeDecompositionProcessor : public htd_io::IGraphToTreeDecompositionProcessor
    {
        public:
            /**
             *  Constructor for a new graph processor.
             */
            HTD_IO_API CustomGrFormatGraphToTreeDecompositionProcessor(const htd::LibraryInstance * const manager);

            /**
             *  Destructor of a graph processor.
             */
            HTD_IO_API virtual ~CustomGrFormatGraphToTreeDecompositionProcessor();
...
#endif /* HTD_IO_CUSTOMGRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP */
